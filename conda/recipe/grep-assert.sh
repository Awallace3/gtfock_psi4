...
GTF_CUDA_LINK_PATTERN='(^|[[:space:]/])(libcuda|libcudart|libcublas|libcudnn|libcufft|libcufile|libcupti|libcurand|libcusolver|libcusparse|libcutensor|libnv[^[:space:]/]*|libnccl|libnpp[^[:space:]/]*)[^[:space:]/]*\.so'
